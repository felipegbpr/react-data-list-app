    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Felipe Borges</span>
          <span className="text-xs text-zinc-400">felipe@example.video</span>
        </div>
        <img
          src="https://avatars.githubusercontent.com/u/149427805?v=4"
